...
Como nuestra variable independiente supervivencia es dicotómica o binaria, debemos utilizar una regresión logistica. A continuación probaremos diferentes modelos, analizando la precisión de cada uno de ellos
...
A continuación analizaremos la correlación existente entre las dos variables cuantitativas (Age y Fare). Utilizamos el coeficiente de Spearman ya que los datos no siguen una distribución normal.
...
Observamos mediante las representaciones gráficas mostradas en el apartado anterior que:
  - Si eres mujer tienens mayores probabilidad de supervivencia
  - Cuanto mayor sea la clase del billete, mayor probabilidad de superviviencia
  - En general, cuanto más joven, mayor probabilidad de superviviencia
